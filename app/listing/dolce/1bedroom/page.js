...
export default function Home() {
  return (
    <div className="bg-[#F9F8EB]">
        ...
        <div className="flex flex-row flex-wrap items-start justify-center px-4 md:px-[100px] pt-[20px] gap-6" data-aos="fade-up">
          ...
          <div className="pt-5 md:pl-9 w-full md:w-[570px]" data-aos="fade-left">
            <h1 className="text-black text-[23px] font-semibold pb-[20px]">
              Dolce Vita 1 Bedroom
            </h1>
            <h1 className="text-black text-[23px] font-semibold pb-[20px]">
              Rp 990 juta - 1,06 Miliar
            </h1>
            <table className="w-full text-left text-gray-700">
              <tbody>
                ...
                <tr className="border-b-[2px] border-gray-400">
                  ...
                  <td className="py-2 text-right">22 - 22,5 M2</td>
                </tr>
                <tr className="border-b-[2px] border-gray-400">
                  <td className="py-2">Semi gross area</td>
                  <td className="py-2 text-right">27 - 28 M2</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div className="mt-[100px] py-12 w-full bg-[#48265F] z-20" data-aos="fade-up">
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <p className="text-white text-[14px]">
            Perhatikan lokasi, harga, legalitas, fasilitas, dan reputasi developer. Perhatikan lokasi, harga, legalitas, fasilitas, dan reputasi developer. Pastikan apartemen berada di lokasi strategis dan dekat dengan fasilitas umum seperti transportasi. Pastikan apartemen berada di lokasi strategis dan dekat dengan fasilitas umum seperti transportasi.
          </p>
        </div>
          ...
          <div className="w-full md:w-[534px]" data-aos="fade-left">
            <div className="pb-4">
              ...
              <p className="text-white text-[14px] font-normal">
                ...
                • Dinding: Precast diplester dan dicat, bata ringan berlapis gypsum/keramik sesuai ruangan.<br />
