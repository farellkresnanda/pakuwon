  ...
  return (
    <div className="bg-[#F9F8EB]">
      ...
      <div className="px-4 md:px-[100px] py-[40px] md:py-[70px]">
        <h1 className="font-semibold text-black text-[28px] md:text-[35px]">Tower Amor</h1>
            ...
            <table className="w-full text-left text-gray-700">
              <tbody>
                ...
                <tr className="border-b-[2px] border-gray-400">
                  ...
                  <td className="py-2 text-right">47,5 - 48,5 M2</td>
                </tr>
                <tr className="border-b-[2px] border-gray-400">
                  <td className="py-2">Semi gross area</td>
                  <td className="py-2 text-right">59 - 60 M2</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div className="bg-[#373737] py-12 px-4 md:px-6">
