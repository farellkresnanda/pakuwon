...
import PropertyDropdownAmor from "../../../../component/comlisting/PropertyDropdownAmor";
...
export default function Home() {
  return (
    <div className="bg-[#F9F8EB]">
            ...
            <table className="w-full text-left text-gray-700">
              <tbody>
                ...
                <tr className="border-b-[2px] border-gray-400">
                  ...
                  <td className="py-2 text-right">27 M2</td>
                </tr>
                <tr className="border-b-[2px] border-gray-400">
                  <td className="py-2">Semi gross area</td>
                  <td className="py-2 text-right">21,5 - 22 M2</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div className="mt-[100px] py-12 w-full bg-[#373737] z-20" data-aos="fade-up">
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <p className="text-white text-[14px]">
              Perhatikan lokasi, harga, legalitas, fasilitas, dan reputasi
              developer. Perhatikan lokasi, harga, legalitas, fasilitas, dan
              reputasi developer. Pastikan apartemen berada di lokasi strategis
              dan dekat dengan fasilitas umum seperti transportasi.
            </p>
          </div>
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center px-6 md:px-[250px] gap-[30px] md:gap-[70px] mt-[40px] md:mt-[63px]">
          ...
          <div className="w-full md:w-[534px]" data-aos="fade-left">
            <div className="pb-4">
              ...
              <div className="w-[534px] h-[2px] bg-[#8A8989] my-[4px]"></div>
              <p className="text-white text-[14px] font-normal">
                • Lantai: Homogeneous Tile<br />
                • Dinding: Precast diplester dan dicat, bata ringan berlapis
                gypsum/keramik sesuai ruangan.<br />
                • Plafon: Concrete expose + skimcoat (ruang keluarga & balkon),
                gypsum board dicat (dapur & kamar mandi).
              </p>
            </div>
            ...
            <div className="pb-4">
              ...
              <div className="w-[534px] h-[2px] bg-[#8A8989] my-[4px]"></div>
              <p className="text-white text-[14px] font-normal">
                • Pintu Utama & Kamar: Kayu dengan architrave finish cat.<br />
                • Pintu Balkon: Aluminium.<br />
            ...
            <div className="pb-4">
              ...
              <div className="w-[534px] h-[2px] bg-[#8A8989] my-[4px]"></div>
              <p className="text-white text-[14px] font-normal">
                • Listrik: 1300 VA (Studio), 2200 VA (2BR).<br />
                • Air: Air bersih & air kotor.<br />
                • TV & AC: Instalasi jaringan TV & pipa AC.<br />
                • Keamanan: Fire alarm, hydrant, sprinkler, heat detector.<br />
