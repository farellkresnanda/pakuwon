  ...
  return (
    <div className="bg-[#F9F8EB]">
      ...
      <div className="px-4 md:px-[100px] py-[40px] md:py-[70px]">
        <h1 className="font-semibold text-black text-[28px] md:text-[35px]">Tower Bella</h1>
        ...
        <div className="flex flex-col md:flex-row items-start justify-center pt-5 gap-6">
          ...
          <div className="w-full md:w-1/2 pt-5 md:pt-0">
            <h2 className="text-black text-[23px] font-semibold pb-4">Bella 2 Bedroom</h2>
            <h2 className="text-black text-[23px] font-semibold pb-6">Rp 1,5 - 2,5 Miliar</h2>
            ...
            <table className="w-full text-left text-gray-700">
              <tbody>
                ...
                <tr className="border-b-[2px] border-gray-400">
                  ...
                  <td className="py-2 text-right">47,5 - 48 M2</td>
                </tr>
                <tr className="border-b-[2px] border-gray-400">
                  <td className="py-2">Semi gross area</td>
                  <td className="py-2 text-right">59 M2</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div className="bg-[#3D542F] py-12 px-4 md:px-6">
              ...
              {[
                {
                  ...
                  content: `• Lantai: Homogeneous Tile di ruang utama & kamar tidur, Ceramic Tile di kamar mandi & balkon.
• Dinding: Precast diplester dicat, partisi gypsum atau bata ringan sesuai ruang, kamar mandi dilapisi keramik.
• Plafon: Concrete expose + skimcoat untuk ruang utama & balkon, gypsum board dicat untuk dapur & kamar mandi.`,
                },
                {
                  title: "Pintu & Jendela",
                  content: `• Pintu utama & kamar: Kayu + architrave finish cat.
• Pintu balkon: Kusen aluminium.
• Jendela: Kaca tinted + kusen aluminium.`,
                ...
                },
                {
                  ...
                  content: `• Listrik: 1300 VA (1BR), 2200 VA (2BR), 3500 VA (3BR).
• Air bersih & air kotor.
• Jaringan TV 1 Outline, pipa AC.
• Fire alarm, hydrant system, sprinkler & heat detector.`,
                },
                {
                  title: "Lain-lain",
                  content: `• Digital smart lock door, kamera CCTV, access card lift.
• Emergency Evacuation Paging System (EVAC Speaker).`,
                },
              ].map((section, index) => (
                <div key={index} className="pb-6">
                  <h3 className="text-white text-[22px] md:text-[25px] font-semibold">{section.title}</h3>
