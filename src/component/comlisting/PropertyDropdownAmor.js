...
const PropertyDropdownAmor = () => {
  ...
  const handleSelect = (type) => {
    ...
    router.push(`/listing/amor/${formattedType}`);
  };
    ...
    <div className="relative flex flex-col gap-4 mt-2 z-20">
      <div className="w-[168px] h-[38px]">
        <button
          ...
          className="w-full flex justify-between items-center bg-[#D9D9D9] px-4 py-2 rounded-lg text-[14px] text-[#696868]"
        >
          {selectedType}
...
export default PropertyDropdownAmor;